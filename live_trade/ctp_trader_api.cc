...
void CTPTraderApi::RequestInstrumentList() {
  CThostFtdcQryInstrumentField req;
  memset(&req, 0, sizeof(req));
  int result = api_->ReqQryInstrument(&req, 0);
}

void CTPTraderApi::ReqQryInstrumentMarginRateList() {
  CThostFtdcQryInstrumentMarginRateField req;
  memset(&req, 0, sizeof(req));
  strcpy(req.InstrumentID, "v1801");
  strcpy(req.InvestorID, "120301760");
  strcpy(req.BrokerID, "66666");
  req.HedgeFlag = THOST_FTDC_HF_Speculation;
  int result = api_->ReqQryInstrumentMarginRate(&req, 0);
}

void CTPTraderApi::ReqQryInstrumentCommissionRateList() {
  CThostFtdcQryInstrumentCommissionRateField req;
  memset(&req, 0, sizeof(req));
  strcpy(req.BrokerID, "66666");
  strcpy(req.InvestorID, "120301760");
  strcpy(req.InstrumentID, "pp1811");
  int result = api_->ReqQryInstrumentCommissionRate(&req, 0);
}

void CTPTraderApi::OnRspQryInstrument(CThostFtdcInstrumentField* pInstrument,
                                      CThostFtdcRspInfoField* pRspInfo,
                                      int nRequestID,
                                      bool bIsLast) {
  static int count = 0;
...
void CTPTraderApi::OnRspQryInstrumentMarginRate(
...
void CTPTraderApi::OnRspQryInstrumentCommissionRate(
